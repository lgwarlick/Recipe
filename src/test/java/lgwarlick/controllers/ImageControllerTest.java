...
import lgwarlick.services.ImageService;
...
class ImageControllerTest {
    ...
    void handleImagePost() throws Exception {
        MockMultipartFile multipartFile =
                new MockMultipartFile("imagefile", "testing.txt", "text/plain", "lgwarlick".getBytes());
    ...
    public void renderImageFromDB() throws Exception {
        ...
        String s = "fake image text"; //just to provide some amount of bytes without using image
